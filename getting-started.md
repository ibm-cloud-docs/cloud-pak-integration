...
IBM Cloud Pak for Integration includes the following components.
  ...
  - Platform Navigator, an integration-specific user interface that allows centralized management and control of all the Cloud Pak for Integration components.
  - Asset Repository, achieve accelerated development through re-use of integration assets across capabilities.
  - [Common Services](https://www.ibm.com/support/knowledgecenter/SSHKN6/kc_welcome_cs.html){: external}, IBM Common Services are a set of private cloud platform services that provide the benefits of the public cloud from the safety of your firewall-protected data center. It offers logging, metering, monitoring and many other key foundational services. Entitlement to IBM Common Services is included in Cloud Pak for Integration to facilitate the transition to OpenShift.
